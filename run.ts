...
import { Flatten1LevelArr } from './src/Flatten1LevelArr.js';
...
console.log(Flatten1LevelArr.getFlatten([1, 2, [3, 4], [5, 6]]));
console.log(Flatten1LevelArr.getFlatten([{ a: 1 }, [{ b: 2 }, { c: 5 }], { c: 5 }, { c: 6 }]));
